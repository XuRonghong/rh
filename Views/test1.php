...
<head>
    ...
    <!-- Custom CSS -->
    <link href="resources/xtreme-admin/assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="resources/xtreme-admin/assets/extra-libs/c3/c3.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="resources/xtreme-admin/dist/css/style.min.css" rel="stylesheet">
...
<body>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="resources/xtreme-admin/assets/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="resources/xtreme-admin/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="resources/xtreme-admin/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- apps -->
    <script src="resources/xtreme-admin/dist/js/app.min.js"></script>
    <!-- full sidebar -->
    <script>
    $(function() {
        "use strict";
    ...
    <script src="resources/xtreme-admin/dist/js/app-style-switcher.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="resources/xtreme-admin/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="resources/xtreme-admin/assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    <script src="resources/xtreme-admin/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="resources/xtreme-admin/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="resources/xtreme-admin/dist/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <!--chartis chart-->
    <script src="resources/xtreme-admin/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="resources/xtreme-admin/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <!--c3 charts -->
    <script src="resources/xtreme-admin/assets/extra-libs/c3/d3.min.js"></script>
    <script src="resources/xtreme-admin/assets/extra-libs/c3/c3.min.js"></script>
    <!--chartjs -->
    <script src="resources/xtreme-admin/assets/libs/chart.js/dist/Chart.min.js"></script>
    <script src="resources/xtreme-admin/dist/js/pages/dashboards/dashboard1.js"></script>
</body>
</html>