                  ...
                  <TR>
                    ...
                    <TD width="242" class="style1">
                      <div align="left" class="style2">
                        <INPUT id="txtAccount2" name="txtAccount2" maxLength="10" size="20" type="text">
                      </div>
                    </TD>
                  </TR>
                  <TR>
                    ...
                    <TD class="style1">
                      <div align="left" class="style2">
                        <INPUT id="txtPassword2" name="txtPassword2" maxLength="30" size="21" type="password">
                      </div>
                    </TD>
                  </TR>
                  <TR>
    ...
    <tr>
      ...
      <td valign="top" background="images/index_10.jpg">
        <table width="132" border="0" cellpadding="0" cellspacing="2">
          <tr>
            <td width="62">
              <div align="right"><a href="index02.htm"><img src="images/btn_ login.gif" alt="登入" width="49" height="23" border="0"></a></div>
            </td>
